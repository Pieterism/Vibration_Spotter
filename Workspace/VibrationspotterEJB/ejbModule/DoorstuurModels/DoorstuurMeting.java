...
/**
 * Simple version of Meting class. Used to simplify working with Gson and prevents
 * sending data that isn't used in the app
 * 
...
public class DoorstuurMeting {
	 ...
	 */
	public DoorstuurMeting(int idMeting, String titel, String tijdstip, String opmerking, String dataset1,
			String dataset2) {
		super();
		this.titel = titel;
